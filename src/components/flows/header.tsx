...
export function EditorHeader() {
  ...
  const tx = useTranslations("Flows.header");
  const {
    flow,
    state,
    setState,
    ...
    <div className="flex flex-col gap-1.5 px-6 pt-5">
      <div className="flex flex-wrap items-center gap-3">
        ...
        <button
          ...
          title={tx("backToFlows")}
          aria-label={tx("backToFlows")}
        ...
        <input
          ...
          placeholder={tx("flowName")}
          spellCheck={false}
          aria-label={tx("flowName")}
