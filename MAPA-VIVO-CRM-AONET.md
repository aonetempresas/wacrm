...
| **B — Métricas por vendedor** | Painel por consultor: taxa de conversão, ticket médio, pipeline, vendas no mês. | Dashboard | 🟡 Médio | A |
